...
def definitions():
    ...
    for name,title,desc,model,kind in (
        ('generate_music','Generate song takes','Generate a new whole-song recording using project settings or the supplied Generation. Duration is composition-dependent. Source takes stay saved.',Music,'generate'),
        ...
        ('separate_stems','Separate stems','Queue Demucs separation for an existing project audio asset. Original audio remains intact.',Source,'separate'),
